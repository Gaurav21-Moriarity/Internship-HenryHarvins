...
dataset = pd.read_excel('Trust Pilot.xlsx')
dataset
dataset.info()
...
fdist.plot(20, title='Top 20 Most Occoured Words in the "Trust Pilot Dataset"') # Plotting the Frequency Data
...
word_cloud.to_file("Trust Pilot.png")
